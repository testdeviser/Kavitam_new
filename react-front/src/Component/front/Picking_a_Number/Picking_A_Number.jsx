         ...
         <div className="container">
            <div className="row ">
               ...
               <div className="col-lg-12">
                  <div className="live_result_sec define_float">
                     {/* <h5 className='heading'>How it works</h5> */}
                     <h5 className='heading hindi_text'>क्या मै कवितम मटका खेलकर जीत सकता हु?</h5>
                     <img className='white_dot_img' src={process.env.PUBLIC_URL + '/image/white-dot-lines.png'} alt="" width={218} height={18} />
                     {/* <h2>Easiest way to picking a number</h2> */}
                     <h2 className='hindi_text'>कवितम मटका में बहुत लोग रुचि रखते हैं। किसी भी नंबर की एक पर्ची खींच कर किसी को विजेता के रूप में चुना जाता है । विजेता वही होगा जिसके पास कार्ड पर वही नंबर है। अगर आप हमारे टिप्स और ब्लोग्स पढ़ेनेगे तोह आप कवितम मटका के किंग बन जाएंगे ।
                     </h2>
                  </div>
               </div>
               ...
               <div className="col-lg-12">
                  <div className="live_result_sec define_float">
                     {/* <h5 className='heading'>How it works</h5> */}
                     <h5 className='heading hindi_text'>आखिर ये सट्टा मटका है क्या?</h5>
                     <img className='white_dot_img' src={process.env.PUBLIC_URL + '/image/white-dot-lines.png'} alt="" width={218} height={18} />
                     {/* <h2>Easiest way to picking a number</h2> */}
                     <h2 className='hindi_text'>
